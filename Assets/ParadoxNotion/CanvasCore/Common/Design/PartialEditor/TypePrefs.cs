...
namespace ParadoxNotion.Design
{
    ...
    public static class TypePrefs
    {
        ...
        //event [Color("c02520")]
        //variable     [Color("151714")] 
        //flowcontrol     [Color("FF7F24")]
        //function     [Color("3a7962")]     simplexNode 216a73
        //reflection     [Color("505050")]
        //nested     [Color("a13574")]

        //SL ----------------------------------------------------------------------------------------------

        static Color UnityComponentColor = new Color(0.3f, 0.6f, 0.6f);
        private static readonly Color DEFAULT_TYPE_COLOR = new Color(0.5f, 0.7f, 0.7f);
        //A Type to color lookup
        private static Dictionary<Type, Color> typeColors = new Dictionary<Type, Color>()
        {
            {typeof(FlowCanvas.Flow),    new Color(0.95f,9f,1.0f)},
            ...
            {typeof(string),             new Color(0.7f,0.55f,0.6f)},
            ...
            {typeof(Behaviour), UnityComponentColor},
            {typeof(Component), UnityComponentColor},
            {typeof(Transform), UnityComponentColor},
            {typeof(Animation), UnityComponentColor},
            {typeof(Animator), UnityComponentColor},
            {typeof(Rigidbody), UnityComponentColor},
            {typeof(Rigidbody2D), UnityComponentColor},
            {typeof(Collider), UnityComponentColor},
            {typeof(Collider2D), UnityComponentColor},
            {typeof(NavMeshAgent), UnityComponentColor},
            {typeof(CharacterController), UnityComponentColor},
            {typeof(AudioSource), UnityComponentColor},
            {typeof(Camera), UnityComponentColor},
            {typeof(Light), UnityComponentColor},
            {typeof(UnityEngine.UI.Button), UnityComponentColor},
            {typeof(UnityEngine.UI.Slider), UnityComponentColor},
        };
