...
namespace NodeCanvas.Framework
{
    ...
    abstract public partial class Graph : ScriptableObject, ITaskSystem, ISerializationCallbackReceiver
    {
        ...
        //SL------------Copy all nodes provided within the target graph. Connections will duplicate only if target nodes of the connections are contained in the provided list
        ...
        //SL--public
        [System.NonSerialized]
        public bool initialReferencesUpdated;
        [System.NonSerialized]
		...
		public void RemoveNode(Node node, bool isReplace = false, bool recordUndo = true, bool force = false)
        {
