...
namespace FlowCanvas.Editor
{
    ...
    public static class Commands
    {
        ...
        //SL--
        [MenuItem("Tools/ParadoxNotion/FlowCanvas/External BlackBoard Inspector Panel")]
        public static void ShowExternalBBInspector()
        {
            ExternalBBInspectorWindow.ShowWindow();
        }
